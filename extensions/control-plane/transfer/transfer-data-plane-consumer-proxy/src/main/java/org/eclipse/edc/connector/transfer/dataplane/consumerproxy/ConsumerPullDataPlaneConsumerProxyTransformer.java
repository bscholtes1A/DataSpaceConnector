...
import org.eclipse.edc.connector.transfer.dataplane.util.ConsumerPullDataPlaneProxyAddressResolver;
 ...
 */
public class ConsumerPullDataPlaneConsumerProxyTransformer implements EndpointDataReferenceTransformer {

    private final DataPlaneSelectorClient selectorClient;
    private final ConsumerPullDataPlaneProxyAddressResolver resolver;

    public ConsumerPullDataPlaneConsumerProxyTransformer(ConsumerPullDataPlaneProxyAddressResolver resolver) {
    ...
    public Result<EndpointDataReference> transform(@NotNull EndpointDataReference edr) {
        ...
        Optional.ofNullable(selectorClient.)

        resolver.toDataAddress(address, contractId);
