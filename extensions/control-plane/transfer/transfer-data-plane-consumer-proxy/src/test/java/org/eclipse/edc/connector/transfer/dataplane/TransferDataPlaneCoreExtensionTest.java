...
import org.eclipse.edc.connector.transfer.dataplane.consumerproxy.ConsumerPullDataPlaneConsumerProxyExtension;
...
class TransferDataPlaneCoreExtensionTest {
    ...
    private ConsumerPullDataPlaneConsumerProxyExtension extension;
    ...
    public void setUp(ServiceExtensionContext context, ObjectFactory factory) throws JOSEException {
        ...
        extension = factory.constructInstance(ConsumerPullDataPlaneConsumerProxyExtension.class);
    }
