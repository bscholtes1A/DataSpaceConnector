...
include(":extensions:data-plane:data-plane-kafka-models")
include(":extensions:data-plane:data-plane-kafka-transfer")
...
include(":system-tests:kafka-transfer-test:runner")
include(":system-tests:kafka-transfer-test:provider")
include(":system-tests:kafka-transfer-test:consumer")
